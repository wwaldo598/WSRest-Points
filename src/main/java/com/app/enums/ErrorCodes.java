...
public enum ErrorCodes {
    ...
    ERR_TRANSACTION_NOT_EXIST 			(-7, "The entered transaction does not exist"),
    ERR_TRANSACTION_ALREADY_EXIST 		(-8, "The entered transaction already exist"),
    ERR_NOT_TRANSACTIONS 			    (-9, "There are not transactions to process"),
